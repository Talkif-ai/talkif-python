...
class RawPhoneProvidersClient:
    ...
    def get_provider(
    ...
    ) -> HttpResponse[PhoneProviderResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/v1/phone/providers/{encode_path_param(id)}",
            method="GET",
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=PhoneProviderResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawPhoneProvidersClient:
    ...
    async def get_provider(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[PhoneProviderResponse]:
        """
        GET /api/v1/phone/providers/:id
